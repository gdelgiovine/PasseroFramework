...
namespace Passero.Framework.Controls
{
    ...
    public partial class XQBEReport : Form
    {
        ...
        public void ExportResultGrid()
        {
            ...
            if (rbExcel.Checked)
            {
                format = SSRSRenderFormat.EXCEL;
                expofilenameextension = ".xls";
            }

            if (rbCSV.Checked)
            {
                format = SSRSRenderFormat.CSV ;
        ...
        private void LoadPDFViewer(string ReportName)
        {
            ...
            byte[] ReportBytes = this.RenderReport(ReportName, SSRSRenderFormat.PDF);
        ...
        private byte[] RenderReport(string ReportName, SSRSRenderFormat Format = SSRSRenderFormat.PDF)
        {
        ...
        private byte[] RenderReport(QBEReport Report, SSRSRenderFormat Format = SSRSRenderFormat.PDF)
        {
            ...
            SSRSReport = new Reports.SSRSReport();
        ...
        private void SetupQueryGrid(QBEReport QBEReport)
        {
            ...
            Passero.Framework.Reports.DataSet PrimaryDataSet = QBEReport.PrimaryDataSet;
        ...
        private void BuildQuery3()
        {
            ...
            Passero.Framework.Reports.DataSet PrimaryDataSet = Report.PrimaryDataSet;
            if (PrimaryDataSet == null)
            {
            ...
            foreach (Passero.Framework.Reports.DataSet DataSet in Report.DataSets.Values )
            {
