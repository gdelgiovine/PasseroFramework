...
namespace Passero.Framework.Controls
{
    ...
    public partial class XQBEForm<ModelClass> : Wisej.Web.Form where ModelClass : class
    {
        ...
        private Dictionary<string, QBEReportSortColumn> QBEReportSortColumns = new Dictionary<string, QBEReportSortColumn>();
        private Dictionary<string, QBEReportSortColumn> QBEReportSelectedSortColumns = new Dictionary<string, QBEReportSortColumn>();
        ...
        public string ReportsPath { get; set; } = Application.StartupPath + "reports";
        ...
        public XQBEForm(IDbConnection DbConnection)
        {
